...
$pdf->Cell(0,4,'LAPORAN HASIL PENGUJIAN LABORATORIUM BIOMOLEKULER',0,1,'C');
...
$pdf->SetWidths(array(6,49,5,110));
...
$im=app_baca("uji_img","idh='".$idh."'","img");
$img="../img/".$im;
if ($im!="") {
...
$pdf->SetBorderColor("#000000");
$pdf->SetAligns(array("J"));
$pdf->Row(array('Kesimpulan: Sampel '.$data['komoditi'].' No. '.$data['kode'].' dari Hasil sequencing dan blast di ncbi - Google http://blast.ncbi.nlm.nih.gov '.$has.' terhadap '.$jenis.' '.$optk.''));

$pdf->SetFont('Arial','',11);
$pdf->SetWidths(array(85,85));
$pdf->SetBorderColor("#000000","#000000");
$pdf->SetAligns(array("C","C"));
$pdf->Row(array("Mengetahui,
Penyelia,



".db_baca("user_login","karyawan","id='".$data['penyelia']."'","nama"),"Jakarta, ".tgl_p($s)."
Analis,



".db_baca("user_login","karyawan","id='".$data['penguji']."'","nama")));

$pdf->SetDrawColor(111, 111, 111);
$pdf->Line(20,80,20,230);
$pdf->Line(190,80,190,230);
