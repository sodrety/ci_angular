...
$id=$_GET['id'];
$no_spt=app_baca("spt","id='$id'","no_spt");
...
$mak=db_baca("b_realisasi_".$tahun,"pok","no='".$mak."'","mak");
...
if ($dip=="" or $dip=="-") {$dipa="-";} else {$dipa=$dip." Tahun Anggaran ".$tahun;}
echo "
...
Bekasi, ".tgl_p($tgl)."<br>$kep_jab<br><br><br><br><u>".db_baca("b_realisasi","karyawan","id='".$kep_nama."'","nama")."</u><br>NIP. ".db_baca("b_realisasi","karyawan","id='".$kep_nama."'","nip")."
</td><td></td></tr></table>
