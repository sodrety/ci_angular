...
$user_id=db_baca("acak_popt","popt","id='".user_id()."'","id");
if ($user_id=='') { 
...
<title>Laboratorium Karantina Tumbuhan</title>
...
$(document).ready(function() {  $('#dt10').DataTable({
...
$(document).ready(function() { $("#sle1").select2(); });
        ...
        $(document).ready(function() { $("#sle20").select2(); });
    </script>
<script>
...
<div class=header>
<div class='h2'>
<table width='100%'><tr><td width='30px'><img src='css/barantan.png' style="width:30px;"></td><td><h2><?php echo "<b>Laboratorium-KT</b>"; ?></h2></td><td class='org'>Balai Besar Karantina Pertanian Tanjung Priok</td></tr></table>
</div>
<div class=menu>
<a id="menu-toggle"><img src='css/menu.png' style="width:20px;height:12px;"></a> &nbsp; <?php echo $menu; ?>
