...
class database7
{
	...
	private $db_host = "192.168.0.24";  // Change as required
	private $db_user = "userNSW";  // Change as required
	private $db_pass = "passwordnyansw";  // Change as required
	//private $db_name = "mysqlii";	// Change as required
    
public function connect($dbnya){
        mb_internal_encoding( 'UTF-8' );
        mb_regex_encoding( 'UTF-8' );
        mysqli_report( MYSQLI_REPORT_STRICT );
        try {
            $this->link = new mysqli($this->db_host,$this->db_user,$this->db_pass,$dbnya,'3007');
...
$sql = "REPLACE INTO ". $table ." VALUES (". $values . ")";
 $query = $this->link->query( $sql );
    ...
    public function update( $table, $wh, $dt )
    {
$dt=str_replace("''","NULL",$dt);
