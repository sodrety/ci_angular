...
class database56
{
	...
	private $db_host = "192.168.1.56";  // Change as required
	private $db_user = "eplaq";  // Change as required
	private $db_pass = "eplaq";  // Change as required
...
public function connect($dbnya){
        ...
        try {
            $this->link = new mysqli($this->db_host,$this->db_user,$this->db_pass,$dbnya);
